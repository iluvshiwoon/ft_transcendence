...
**Git repository:** `git@vogsphere.42paris.fr:vogsphere/intra-uuid-25d0c47c-31de-4e02-b7ba-021da6a992c1-73`
...
- subject.pdf (https://cdn.intra.42.fr/pdf/pdf/199868/en.subject.pdf)
...
> The deployment should be straightforward and work without manual intervention.

> Verify that all services start correctly and the application is accessible.
